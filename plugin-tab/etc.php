...
if ( ! function_exists ( 'oxsn_navigation_plugin_nav_item' ) ) {

	add_action('admin_menu', 'oxsn_navigation_plugin_nav_item', 99);
	function oxsn_navigation_plugin_nav_item() {

		add_submenu_page('oxsn-dashboard', 'OXSN Navigation', 'Navigation', 'manage_options', 'oxsn-navigation', 'oxsn_navigation_plugin');

	}

}

if ( !function_exists('oxsn_navigation_plugin') ) {

	function oxsn_navigation_plugin() {
	...
	?>
		...
		<div class="wrap oxsn-settings-page">
		
			<h2>OXSN Navigation Plugin</h2>
